...
<template>
    <div class="min-h-screen flex relative lg:static bg-surface-50 dark:bg-surface-950">
        <div id="app-sidebar-1"
            class="bg-surface-0 dark:bg-surface-950 h-screen hidden lg:block flex-shrink-0 absolute lg:static left-0 top-0 z-10 border-r border-surface select-none w-[280px]">
            <div class="flex flex-col h-full">
                            ...
                            <ul class="list-none p-0 m-0 overflow-hidden">
                                <li>
                                    <a @click="setSelectedItem('dashboard')"
                                        class="flex items-center cursor-pointer p-4 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors">
                                ...
                                <li>
                                    <a
                                        ...
                                        <span
                                            class="inline-flex items-center justify-center ml-auto bg-primary text-primary-contrast dark:text-surface-900 rounded-full min-w-6 h-6">3</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                ...
                <div class="mt-auto">
                    ...
                    <a
                        class="m-4 flex items-center cursor-pointer p-4 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors">
        ...
        <div class="min-h-screen flex flex-col relative flex-auto">
            <div
                class="flex justify-between items-center px-8 bg-surface-0 dark:bg-surface-900 border-b border-surface relative lg:static h-[60px]">
                <div class="flex">
                    <a v-styleclass="{
                    ...
                    <li class="border-t border-surface lg:border-t-0">
                        <a
                            ...
                            <div class="block lg:hidden">
                                ...
                                <span class="text-surface-600 dark:text-surface-200 font-medium text-sm">Marketing
                                    Specialist</span>
                            </div>
                        </a>
                    </li>
            ...
            <div class="p-8 flex flex-col flex-auto">
                <div
                    class=" my-10 bg-surface-0 dark:bg-surface-950 flex-auto">
